...
import com.configure_me_test1obw_sdk.api.core.http.HttpClient
...
import com.configure_me_test1obw_sdk.api.core.http.HttpRequestBody
import com.configure_me_test1obw_sdk.api.core.http.HttpResponse
import com.configure_me_test1obw_sdk.api.errors.Test1obwSdkIoException
...
private constructor(private val okHttpClient: okhttp3.OkHttpClient, private val baseUrl: HttpUrl) :
    ...
    override fun execute(
        ...
        return try {
            ...
            throw Test1obwSdkIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
