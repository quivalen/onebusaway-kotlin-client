...
sealed class JsonField<out T : Any> {
    ...
    fun asStringOrThrow(): String =
        when (this) {
            is JsonString -> value
            else -> throw Test1obwSdkInvalidDataException("Value is not a string")
        }
    ...
    internal fun getRequired(name: String): T =
        when (this) {
            is KnownValue -> value
            is JsonMissing -> throw Test1obwSdkInvalidDataException("'${name}' is not set")
            is JsonNull -> throw Test1obwSdkInvalidDataException("'${name}' is null")
            else -> throw Test1obwSdkInvalidDataException("'${name}' is invalid, received ${this}")
        }
