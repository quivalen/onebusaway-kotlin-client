...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TripReportProblemParams &&
    ...
    class Builder {
        ...
        internal fun from(tripReportProblemParams: TripReportProblemParams) = apply {
            this.tripId = tripReportProblemParams.tripId
            this.code = tripReportProblemParams.code
            this.serviceDate = tripReportProblemParams.serviceDate
            this.stopId = tripReportProblemParams.stopId
            this.userComment = tripReportProblemParams.userComment
            this.userLat = tripReportProblemParams.userLat
            this.userLocationAccuracy = tripReportProblemParams.userLocationAccuracy
            this.userLon = tripReportProblemParams.userLon
            this.userOnVehicle = tripReportProblemParams.userOnVehicle
            this.userVehicleNumber = tripReportProblemParams.userVehicleNumber
            this.vehicleId = tripReportProblemParams.vehicleId
            additionalQueryParams(tripReportProblemParams.additionalQueryParams)
            additionalHeaders(tripReportProblemParams.additionalHeaders)
        }
        ...
        fun build(): TripReportProblemParams =
            TripReportProblemParams(
