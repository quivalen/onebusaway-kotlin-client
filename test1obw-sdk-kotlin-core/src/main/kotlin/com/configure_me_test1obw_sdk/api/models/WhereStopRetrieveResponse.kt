...
@JsonDeserialize(builder = WhereStopRetrieveResponse.Builder::class)
@NoAutoDetect
class WhereStopRetrieveResponse
private constructor(
    ...
    fun validate(): WhereStopRetrieveResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhereStopRetrieveResponse &&
    ...
    override fun toString() =
        "WhereStopRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(whereStopRetrieveResponse: WhereStopRetrieveResponse) = apply {
            this.code = whereStopRetrieveResponse.code
            this.currentTime = whereStopRetrieveResponse.currentTime
            this.text = whereStopRetrieveResponse.text
            this.version = whereStopRetrieveResponse.version
            this.data = whereStopRetrieveResponse.data
            additionalProperties(whereStopRetrieveResponse.additionalProperties)
        }
        ...
        fun build(): WhereStopRetrieveResponse =
