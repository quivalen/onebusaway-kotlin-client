...
@JsonDeserialize(builder = WhereVehiclesForAgencyRetrieveResponse.Builder::class)
@NoAutoDetect
class WhereVehiclesForAgencyRetrieveResponse
private constructor(
    ...
    fun validate(): WhereVehiclesForAgencyRetrieveResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhereVehiclesForAgencyRetrieveResponse &&
    ...
    override fun toString() =
        "WhereVehiclesForAgencyRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(
            whereVehiclesForAgencyRetrieveResponse: WhereVehiclesForAgencyRetrieveResponse
        ) = apply {
            this.code = whereVehiclesForAgencyRetrieveResponse.code
            this.currentTime = whereVehiclesForAgencyRetrieveResponse.currentTime
            this.text = whereVehiclesForAgencyRetrieveResponse.text
            this.version = whereVehiclesForAgencyRetrieveResponse.version
            this.data = whereVehiclesForAgencyRetrieveResponse.data
            additionalProperties(whereVehiclesForAgencyRetrieveResponse.additionalProperties)
        }
        ...
        fun build(): WhereVehiclesForAgencyRetrieveResponse =
