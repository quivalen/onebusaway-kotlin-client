...
class WhereTripsForLocationListParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhereTripsForLocationListParams &&
            this.lat == other.lat &&
    ...
    override fun toString() =
        "WhereTripsForLocationListParams{lat=$lat, latSpan=$latSpan, lon=$lon, lonSpan=$lonSpan, includeSchedule=$includeSchedule, includeTrip=$includeTrip, time=$time, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(whereTripsForLocationListParams: WhereTripsForLocationListParams) =
            apply {
                this.lat = whereTripsForLocationListParams.lat
                this.latSpan = whereTripsForLocationListParams.latSpan
                this.lon = whereTripsForLocationListParams.lon
                this.lonSpan = whereTripsForLocationListParams.lonSpan
                this.includeSchedule = whereTripsForLocationListParams.includeSchedule
                this.includeTrip = whereTripsForLocationListParams.includeTrip
                this.time = whereTripsForLocationListParams.time
                additionalQueryParams(whereTripsForLocationListParams.additionalQueryParams)
                additionalHeaders(whereTripsForLocationListParams.additionalHeaders)
            }
        ...
        fun build(): WhereTripsForLocationListParams =
            WhereTripsForLocationListParams(
