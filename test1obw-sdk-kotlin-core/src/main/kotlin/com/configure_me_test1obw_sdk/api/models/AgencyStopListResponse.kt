...
@JsonDeserialize(builder = AgencyStopListResponse.Builder::class)
@NoAutoDetect
class AgencyStopListResponse
private constructor(
    ...
    fun validate(): AgencyStopListResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgencyStopListResponse &&
    ...
    override fun toString() =
        "AgencyStopListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(agencyStopListResponse: AgencyStopListResponse) = apply {
            this.code = agencyStopListResponse.code
            this.currentTime = agencyStopListResponse.currentTime
            this.text = agencyStopListResponse.text
            this.version = agencyStopListResponse.version
            this.data = agencyStopListResponse.data
            additionalProperties(agencyStopListResponse.additionalProperties)
        }
        ...
        fun build(): AgencyStopListResponse =
