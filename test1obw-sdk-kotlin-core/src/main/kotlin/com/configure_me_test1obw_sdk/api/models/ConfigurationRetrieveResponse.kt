...
@JsonDeserialize(builder = ConfigurationRetrieveResponse.Builder::class)
@NoAutoDetect
class ConfigurationRetrieveResponse
private constructor(
    ...
    fun validate(): ConfigurationRetrieveResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConfigurationRetrieveResponse &&
    ...
    override fun toString() =
        "ConfigurationRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(configurationRetrieveResponse: ConfigurationRetrieveResponse) = apply {
            this.code = configurationRetrieveResponse.code
            this.currentTime = configurationRetrieveResponse.currentTime
            this.text = configurationRetrieveResponse.text
            this.version = configurationRetrieveResponse.version
            this.data = configurationRetrieveResponse.data
            additionalProperties(configurationRetrieveResponse.additionalProperties)
        }
        ...
        fun build(): ConfigurationRetrieveResponse =
