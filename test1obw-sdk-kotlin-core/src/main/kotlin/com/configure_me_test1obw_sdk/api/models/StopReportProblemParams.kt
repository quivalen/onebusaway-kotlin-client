...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StopReportProblemParams &&
    ...
    override fun toString() =
        "StopReportProblemParams{stopId=$stopId, code=$code, userComment=$userComment, userLat=$userLat, userLocationAccuracy=$userLocationAccuracy, userLon=$userLon, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(stopReportProblemParams: StopReportProblemParams) = apply {
            this.stopId = stopReportProblemParams.stopId
            this.code = stopReportProblemParams.code
            this.userComment = stopReportProblemParams.userComment
            this.userLat = stopReportProblemParams.userLat
            this.userLocationAccuracy = stopReportProblemParams.userLocationAccuracy
            this.userLon = stopReportProblemParams.userLon
            additionalQueryParams(stopReportProblemParams.additionalQueryParams)
            additionalHeaders(stopReportProblemParams.additionalHeaders)
        }
        ...
        fun build(): StopReportProblemParams =
            StopReportProblemParams(
