...
@JsonDeserialize(builder = ScheduleRetrieveResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    fun validate(): ScheduleRetrieveResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScheduleRetrieveResponse &&
    ...
    override fun toString() =
        "ScheduleRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(scheduleRetrieveResponse: ScheduleRetrieveResponse) = apply {
            this.code = scheduleRetrieveResponse.code
            this.currentTime = scheduleRetrieveResponse.currentTime
            this.text = scheduleRetrieveResponse.text
            this.version = scheduleRetrieveResponse.version
            this.data = scheduleRetrieveResponse.data
            additionalProperties(scheduleRetrieveResponse.additionalProperties)
        }
        ...
        fun build(): ScheduleRetrieveResponse =
