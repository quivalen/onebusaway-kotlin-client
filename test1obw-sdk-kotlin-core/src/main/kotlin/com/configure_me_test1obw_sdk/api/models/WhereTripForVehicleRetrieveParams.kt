...
class WhereTripForVehicleRetrieveParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhereTripForVehicleRetrieveParams &&
    ...
    override fun toString() =
        "WhereTripForVehicleRetrieveParams{vehicleId=$vehicleId, includeSchedule=$includeSchedule, includeStatus=$includeStatus, includeTrip=$includeTrip, time=$time, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(whereTripForVehicleRetrieveParams: WhereTripForVehicleRetrieveParams) =
            apply {
                this.vehicleId = whereTripForVehicleRetrieveParams.vehicleId
                this.includeSchedule = whereTripForVehicleRetrieveParams.includeSchedule
                this.includeStatus = whereTripForVehicleRetrieveParams.includeStatus
                this.includeTrip = whereTripForVehicleRetrieveParams.includeTrip
                this.time = whereTripForVehicleRetrieveParams.time
                additionalQueryParams(whereTripForVehicleRetrieveParams.additionalQueryParams)
                additionalHeaders(whereTripForVehicleRetrieveParams.additionalHeaders)
            }
        ...
        fun build(): WhereTripForVehicleRetrieveParams =
            WhereTripForVehicleRetrieveParams(
