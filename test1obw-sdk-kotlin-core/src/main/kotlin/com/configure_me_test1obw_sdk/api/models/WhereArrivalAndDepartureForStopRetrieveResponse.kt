...
@JsonDeserialize(builder = WhereArrivalAndDepartureForStopRetrieveResponse.Builder::class)
@NoAutoDetect
class WhereArrivalAndDepartureForStopRetrieveResponse
private constructor(
    ...
    fun validate(): WhereArrivalAndDepartureForStopRetrieveResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhereArrivalAndDepartureForStopRetrieveResponse &&
    ...
    override fun toString() =
        "WhereArrivalAndDepartureForStopRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(
            ...
            this.code = whereArrivalAndDepartureForStopRetrieveResponse.code
            this.currentTime = whereArrivalAndDepartureForStopRetrieveResponse.currentTime
            this.text = whereArrivalAndDepartureForStopRetrieveResponse.text
            this.version = whereArrivalAndDepartureForStopRetrieveResponse.version
            this.data = whereArrivalAndDepartureForStopRetrieveResponse.data
            additionalProperties(
                whereArrivalAndDepartureForStopRetrieveResponse.additionalProperties
            )
        }
        ...
        fun build(): WhereArrivalAndDepartureForStopRetrieveResponse =
            WhereArrivalAndDepartureForStopRetrieveResponse(
                code,
                currentTime,
                text,
