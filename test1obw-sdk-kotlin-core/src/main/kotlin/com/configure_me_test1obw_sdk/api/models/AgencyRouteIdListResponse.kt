...
@JsonDeserialize(builder = AgencyRouteIdListResponse.Builder::class)
@NoAutoDetect
class AgencyRouteIdListResponse
private constructor(
    ...
    fun validate(): AgencyRouteIdListResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgencyRouteIdListResponse &&
    ...
    override fun toString() =
        "AgencyRouteIdListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(agencyRouteIdListResponse: AgencyRouteIdListResponse) = apply {
            this.code = agencyRouteIdListResponse.code
            this.currentTime = agencyRouteIdListResponse.currentTime
            this.text = agencyRouteIdListResponse.text
            this.version = agencyRouteIdListResponse.version
            this.data = agencyRouteIdListResponse.data
            additionalProperties(agencyRouteIdListResponse.additionalProperties)
        }
        ...
        fun build(): AgencyRouteIdListResponse =
