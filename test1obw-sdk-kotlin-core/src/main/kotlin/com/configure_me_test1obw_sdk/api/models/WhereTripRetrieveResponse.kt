...
@JsonDeserialize(builder = WhereTripRetrieveResponse.Builder::class)
@NoAutoDetect
class WhereTripRetrieveResponse
private constructor(
    ...
    fun validate(): WhereTripRetrieveResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhereTripRetrieveResponse &&
    ...
    override fun toString() =
        "WhereTripRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(whereTripRetrieveResponse: WhereTripRetrieveResponse) = apply {
            this.code = whereTripRetrieveResponse.code
            this.currentTime = whereTripRetrieveResponse.currentTime
            this.text = whereTripRetrieveResponse.text
            this.version = whereTripRetrieveResponse.version
            this.data = whereTripRetrieveResponse.data
            additionalProperties(whereTripRetrieveResponse.additionalProperties)
        }
        ...
        fun build(): WhereTripRetrieveResponse =
