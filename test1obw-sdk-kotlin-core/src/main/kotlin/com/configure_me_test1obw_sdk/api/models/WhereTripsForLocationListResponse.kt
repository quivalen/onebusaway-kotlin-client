...
@JsonDeserialize(builder = WhereTripsForLocationListResponse.Builder::class)
@NoAutoDetect
class WhereTripsForLocationListResponse
private constructor(
    ...
    fun validate(): WhereTripsForLocationListResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhereTripsForLocationListResponse &&
    ...
    override fun toString() =
        "WhereTripsForLocationListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(whereTripsForLocationListResponse: WhereTripsForLocationListResponse) =
            apply {
                this.code = whereTripsForLocationListResponse.code
                this.currentTime = whereTripsForLocationListResponse.currentTime
                this.text = whereTripsForLocationListResponse.text
                this.version = whereTripsForLocationListResponse.version
                this.data = whereTripsForLocationListResponse.data
                additionalProperties(whereTripsForLocationListResponse.additionalProperties)
            }
        ...
        fun build(): WhereTripsForLocationListResponse =
