...
@JsonDeserialize(builder = WhereTripForVehicleRetrieveResponse.Builder::class)
@NoAutoDetect
class WhereTripForVehicleRetrieveResponse
private constructor(
    ...
    fun validate(): WhereTripForVehicleRetrieveResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhereTripForVehicleRetrieveResponse &&
    ...
    override fun toString() =
        "WhereTripForVehicleRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(
            whereTripForVehicleRetrieveResponse: WhereTripForVehicleRetrieveResponse
        ) = apply {
            this.code = whereTripForVehicleRetrieveResponse.code
            this.currentTime = whereTripForVehicleRetrieveResponse.currentTime
            this.text = whereTripForVehicleRetrieveResponse.text
            this.version = whereTripForVehicleRetrieveResponse.version
            this.data = whereTripForVehicleRetrieveResponse.data
            additionalProperties(whereTripForVehicleRetrieveResponse.additionalProperties)
        }
        ...
        fun build(): WhereTripForVehicleRetrieveResponse =
