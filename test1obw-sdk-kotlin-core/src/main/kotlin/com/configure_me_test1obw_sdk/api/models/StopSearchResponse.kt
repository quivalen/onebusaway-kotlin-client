...
@JsonDeserialize(builder = StopSearchResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    fun validate(): StopSearchResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StopSearchResponse &&
    ...
    override fun toString() =
        "StopSearchResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(stopSearchResponse: StopSearchResponse) = apply {
            this.code = stopSearchResponse.code
            this.currentTime = stopSearchResponse.currentTime
            this.text = stopSearchResponse.text
            this.version = stopSearchResponse.version
            this.data = stopSearchResponse.data
            additionalProperties(stopSearchResponse.additionalProperties)
        }
