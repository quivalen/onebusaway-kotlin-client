...
import com.configure_me_test1obw_sdk.api.core.Enum
...
@JsonDeserialize(builder = WhereArrivalsAndDeparturesForStopRetrieveResponse.Builder::class)
@NoAutoDetect
class WhereArrivalsAndDeparturesForStopRetrieveResponse
private constructor(
    ...
    fun validate(): WhereArrivalsAndDeparturesForStopRetrieveResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhereArrivalsAndDeparturesForStopRetrieveResponse &&
    ...
    override fun toString() =
        "WhereArrivalsAndDeparturesForStopRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(
            ...
            this.code = whereArrivalsAndDeparturesForStopRetrieveResponse.code
            this.currentTime = whereArrivalsAndDeparturesForStopRetrieveResponse.currentTime
            this.text = whereArrivalsAndDeparturesForStopRetrieveResponse.text
            this.version = whereArrivalsAndDeparturesForStopRetrieveResponse.version
            this.data = whereArrivalsAndDeparturesForStopRetrieveResponse.data
            additionalProperties(
                whereArrivalsAndDeparturesForStopRetrieveResponse.additionalProperties
            )
        }
        ...
        fun build(): WhereArrivalsAndDeparturesForStopRetrieveResponse =
            WhereArrivalsAndDeparturesForStopRetrieveResponse(
                code,
                currentTime,
                text,
                ...
                private constructor(
                    ...
                    fun known(): Known =
                        when (this) {
                            ...
                            else -> throw Test1obwSdkInvalidDataException("Unknown Reason: $value")
                        }
