...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScheduleRetrieveParams &&
    ...
    override fun toString() =
        "ScheduleRetrieveParams{stopId=$stopId, date=$date, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(scheduleRetrieveParams: ScheduleRetrieveParams) = apply {
            this.stopId = scheduleRetrieveParams.stopId
            this.date = scheduleRetrieveParams.date
            additionalQueryParams(scheduleRetrieveParams.additionalQueryParams)
            additionalHeaders(scheduleRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): ScheduleRetrieveParams =
