...
constructor(
    ...
    override fun toString() =
        "RouteSearchParams{input=$input, maxCount=$maxCount, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(routeSearchParams: RouteSearchParams) = apply {
            this.input = routeSearchParams.input
            this.maxCount = routeSearchParams.maxCount
            additionalQueryParams(routeSearchParams.additionalQueryParams)
            additionalHeaders(routeSearchParams.additionalHeaders)
        }
