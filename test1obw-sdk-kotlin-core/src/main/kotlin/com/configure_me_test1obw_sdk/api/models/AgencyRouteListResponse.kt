...
@JsonDeserialize(builder = AgencyRouteListResponse.Builder::class)
@NoAutoDetect
class AgencyRouteListResponse
private constructor(
    ...
    fun validate(): AgencyRouteListResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgencyRouteListResponse &&
    ...
    override fun toString() =
        "AgencyRouteListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(agencyRouteListResponse: AgencyRouteListResponse) = apply {
            this.code = agencyRouteListResponse.code
            this.currentTime = agencyRouteListResponse.currentTime
            this.text = agencyRouteListResponse.text
            this.version = agencyRouteListResponse.version
            this.data = agencyRouteListResponse.data
            additionalProperties(agencyRouteListResponse.additionalProperties)
        }
        ...
        fun build(): AgencyRouteListResponse =
