...
@JsonDeserialize(builder = WhereTripsForRouteListResponse.Builder::class)
@NoAutoDetect
class WhereTripsForRouteListResponse
private constructor(
    ...
    fun validate(): WhereTripsForRouteListResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhereTripsForRouteListResponse &&
    ...
    override fun toString() =
        "WhereTripsForRouteListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(whereTripsForRouteListResponse: WhereTripsForRouteListResponse) = apply {
            this.code = whereTripsForRouteListResponse.code
            this.currentTime = whereTripsForRouteListResponse.currentTime
            this.text = whereTripsForRouteListResponse.text
            this.version = whereTripsForRouteListResponse.version
            this.data = whereTripsForRouteListResponse.data
            additionalProperties(whereTripsForRouteListResponse.additionalProperties)
        }
        ...
        fun build(): WhereTripsForRouteListResponse =
