...
@JsonDeserialize(builder = RouteSearchResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    fun validate(): RouteSearchResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RouteSearchResponse &&
    ...
    override fun toString() =
        "RouteSearchResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(routeSearchResponse: RouteSearchResponse) = apply {
            this.code = routeSearchResponse.code
            this.currentTime = routeSearchResponse.currentTime
            this.text = routeSearchResponse.text
            this.version = routeSearchResponse.version
            this.data = routeSearchResponse.data
            additionalProperties(routeSearchResponse.additionalProperties)
        }
