...
@JsonDeserialize(builder = WhereTripDetailRetrieveResponse.Builder::class)
@NoAutoDetect
class WhereTripDetailRetrieveResponse
private constructor(
    ...
    fun validate(): WhereTripDetailRetrieveResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhereTripDetailRetrieveResponse &&
    ...
    override fun toString() =
        "WhereTripDetailRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(whereTripDetailRetrieveResponse: WhereTripDetailRetrieveResponse) =
            apply {
                this.code = whereTripDetailRetrieveResponse.code
                this.currentTime = whereTripDetailRetrieveResponse.currentTime
                this.text = whereTripDetailRetrieveResponse.text
                this.version = whereTripDetailRetrieveResponse.version
                this.data = whereTripDetailRetrieveResponse.data
                additionalProperties(whereTripDetailRetrieveResponse.additionalProperties)
            }
        ...
        fun build(): WhereTripDetailRetrieveResponse =
