...
@JsonDeserialize(builder = StopsForRouteResponse.Builder::class)
@NoAutoDetect
class StopsForRouteResponse
private constructor(
    ...
    fun validate(): StopsForRouteResponse = apply {
        if (!validated) {
            data().validate()
            validated = true
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StopsForRouteResponse &&
    ...
    override fun toString() =
        "StopsForRouteResponse{data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(stopsForRouteResponse: StopsForRouteResponse) = apply {
            this.data = stopsForRouteResponse.data
            additionalProperties(stopsForRouteResponse.additionalProperties)
        }
        ...
        fun build(): StopsForRouteResponse =
            StopsForRouteResponse(data, additionalProperties.toUnmodifiable())
    }
