...
import com.configure_me_test1obw_sdk.api.core.MultipartFormValue
    ...
    return object : HttpRequestBody {
        ...
        private fun serialize(): ByteArray {
            ...
            try {
                ...
                throw Test1obwSdkException("Error writing request", e)
            }
        }
            ...
            when (part.value) {
                is JsonValue -> {
                    ...
                    try {
                        ...
                        throw Test1obwSdkException("Error serializing value to json", e)
                    }
