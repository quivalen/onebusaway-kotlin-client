...
import com.onebusawaykt.api.core.http.HttpClient
import com.onebusawaykt.api.core.http.HttpMethod
import com.onebusawaykt.api.core.http.HttpRequest
import com.onebusawaykt.api.core.http.HttpRequestBody
import com.onebusawaykt.api.core.http.HttpResponse
import com.onebusawaykt.api.errors.OnebusawayktIoException
...
private constructor(private val okHttpClient: okhttp3.OkHttpClient, private val baseUrl: HttpUrl) :
    ...
    override fun execute(
        ...
        return try {
            ...
            throw OnebusawayktIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
