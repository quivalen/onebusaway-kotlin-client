...
class CoverageServiceTest {
    ...
    fun callList() {
        ...
        val coverageService = client.agencies().coverage()
        val agencyCoverageListResponse =
            coverageService.list(AgencyCoverageListParams.builder().build())
        println(agencyCoverageListResponse)
        agencyCoverageListResponse.validate()
    }
}
