...
import com.onebusawaykt.api.core.MultipartFormValue
    ...
    return object : HttpRequestBody {
        ...
        private fun serialize(): ByteArray {
            ...
            try {
                ...
                throw OnebusawayktException("Error writing request", e)
            }
        }
            ...
            when (part.value) {
                is JsonValue -> {
                    ...
                    try {
                        ...
                        throw OnebusawayktException("Error serializing value to json", e)
                    }
