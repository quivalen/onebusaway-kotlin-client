package com.onebusawaykt.api.core
...
sealed class JsonField<out T : Any> {
    ...
    fun asStringOrThrow(): String =
        when (this) {
            is JsonString -> value
            else -> throw OnebusawayktInvalidDataException("Value is not a string")
        }
    ...
    internal fun getRequired(name: String): T =
        when (this) {
            is KnownValue -> value
            is JsonMissing -> throw OnebusawayktInvalidDataException("'${name}' is not set")
            is JsonNull -> throw OnebusawayktInvalidDataException("'${name}' is null")
            else -> throw OnebusawayktInvalidDataException("'${name}' is invalid, received ${this}")
        }
