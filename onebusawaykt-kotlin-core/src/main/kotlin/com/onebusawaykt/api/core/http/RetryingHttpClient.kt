...
private constructor(
    ...
    private fun shouldRetry(throwable: Throwable): Boolean {
        // Only retry IOException and OnebusawayktIoException, other exceptions are not intended to
        // be
        // retried.
        return throwable is IOException || throwable is OnebusawayktIoException
    }
