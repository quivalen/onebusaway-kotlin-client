...
class StopReportProblemRetrieveParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StopReportProblemRetrieveParams &&
    ...
    override fun toString() =
        "StopReportProblemRetrieveParams{stopId=$stopId, code=$code, userComment=$userComment, userLat=$userLat, userLocationAccuracy=$userLocationAccuracy, userLon=$userLon, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(stopReportProblemRetrieveParams: StopReportProblemRetrieveParams) =
            apply {
                this.stopId = stopReportProblemRetrieveParams.stopId
                this.code = stopReportProblemRetrieveParams.code
                this.userComment = stopReportProblemRetrieveParams.userComment
                this.userLat = stopReportProblemRetrieveParams.userLat
                this.userLocationAccuracy = stopReportProblemRetrieveParams.userLocationAccuracy
                this.userLon = stopReportProblemRetrieveParams.userLon
                additionalQueryParams(stopReportProblemRetrieveParams.additionalQueryParams)
                additionalHeaders(stopReportProblemRetrieveParams.additionalHeaders)
            }
        ...
        fun build(): StopReportProblemRetrieveParams =
            StopReportProblemRetrieveParams(
