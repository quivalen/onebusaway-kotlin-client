...
@JsonDeserialize(builder = AgencyCoverageListResponse.Builder::class)
@NoAutoDetect
class AgencyCoverageListResponse
private constructor(
    ...
    fun validate(): AgencyCoverageListResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgencyCoverageListResponse &&
    ...
    override fun toString() =
        "AgencyCoverageListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(agencyCoverageListResponse: AgencyCoverageListResponse) = apply {
            this.code = agencyCoverageListResponse.code
            this.currentTime = agencyCoverageListResponse.currentTime
            this.text = agencyCoverageListResponse.text
            this.version = agencyCoverageListResponse.version
            this.data = agencyCoverageListResponse.data
            additionalProperties(agencyCoverageListResponse.additionalProperties)
        }
        ...
        fun build(): AgencyCoverageListResponse =
