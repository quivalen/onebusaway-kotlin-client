...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RouteLocationListParams &&
            this.lat == other.lat &&
            this.lon == other.lon &&
    ...
    override fun toString() =
        "RouteLocationListParams{lat=$lat, lon=$lon, latSpan=$latSpan, lonSpan=$lonSpan, query=$query, radius=$radius, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(routeLocationListParams: RouteLocationListParams) = apply {
            this.lat = routeLocationListParams.lat
            this.lon = routeLocationListParams.lon
            this.latSpan = routeLocationListParams.latSpan
            this.lonSpan = routeLocationListParams.lonSpan
            this.query = routeLocationListParams.query
            this.radius = routeLocationListParams.radius
            additionalQueryParams(routeLocationListParams.additionalQueryParams)
            additionalHeaders(routeLocationListParams.additionalHeaders)
        }
        ...
        fun build(): RouteLocationListParams =
            RouteLocationListParams(
