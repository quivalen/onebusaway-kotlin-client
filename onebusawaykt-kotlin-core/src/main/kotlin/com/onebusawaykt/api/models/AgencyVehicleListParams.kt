...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgencyVehicleListParams &&
    ...
    override fun toString() =
        "AgencyVehicleListParams{agencyId=$agencyId, time=$time, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(agencyVehicleListParams: AgencyVehicleListParams) = apply {
            this.agencyId = agencyVehicleListParams.agencyId
            this.time = agencyVehicleListParams.time
            additionalQueryParams(agencyVehicleListParams.additionalQueryParams)
            additionalHeaders(agencyVehicleListParams.additionalHeaders)
        }
        ...
        fun build(): AgencyVehicleListParams =
            AgencyVehicleListParams(
