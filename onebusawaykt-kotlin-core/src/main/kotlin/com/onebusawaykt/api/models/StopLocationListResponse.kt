...
@JsonDeserialize(builder = StopLocationListResponse.Builder::class)
@NoAutoDetect
class StopLocationListResponse
private constructor(
    ...
    fun validate(): StopLocationListResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StopLocationListResponse &&
    ...
    override fun toString() =
        "StopLocationListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(stopLocationListResponse: StopLocationListResponse) = apply {
            this.code = stopLocationListResponse.code
            this.currentTime = stopLocationListResponse.currentTime
            this.text = stopLocationListResponse.text
            this.version = stopLocationListResponse.version
            this.data = stopLocationListResponse.data
            additionalProperties(stopLocationListResponse.additionalProperties)
        }
        ...
        fun build(): StopLocationListResponse =
