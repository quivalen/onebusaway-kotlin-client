...
@JsonDeserialize(builder = StopSearchRetrieveResponse.Builder::class)
@NoAutoDetect
class StopSearchRetrieveResponse
private constructor(
    ...
    fun validate(): StopSearchRetrieveResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StopSearchRetrieveResponse &&
    ...
    override fun toString() =
        "StopSearchRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(stopSearchRetrieveResponse: StopSearchRetrieveResponse) = apply {
            this.code = stopSearchRetrieveResponse.code
            this.currentTime = stopSearchRetrieveResponse.currentTime
            this.text = stopSearchRetrieveResponse.text
            this.version = stopSearchRetrieveResponse.version
            this.data = stopSearchRetrieveResponse.data
            additionalProperties(stopSearchRetrieveResponse.additionalProperties)
        }
        ...
        fun build(): StopSearchRetrieveResponse =
