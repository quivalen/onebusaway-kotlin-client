...
@JsonDeserialize(builder = StopScheduleForStopRetrieveResponse.Builder::class)
@NoAutoDetect
class StopScheduleForStopRetrieveResponse
private constructor(
    ...
    fun validate(): StopScheduleForStopRetrieveResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StopScheduleForStopRetrieveResponse &&
    ...
    override fun toString() =
        "StopScheduleForStopRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(
            stopScheduleForStopRetrieveResponse: StopScheduleForStopRetrieveResponse
        ) = apply {
            this.code = stopScheduleForStopRetrieveResponse.code
            this.currentTime = stopScheduleForStopRetrieveResponse.currentTime
            this.text = stopScheduleForStopRetrieveResponse.text
            this.version = stopScheduleForStopRetrieveResponse.version
            this.data = stopScheduleForStopRetrieveResponse.data
            additionalProperties(stopScheduleForStopRetrieveResponse.additionalProperties)
        }
        ...
        fun build(): StopScheduleForStopRetrieveResponse =
