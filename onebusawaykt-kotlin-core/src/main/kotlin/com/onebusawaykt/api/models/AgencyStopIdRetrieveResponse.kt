...
@JsonDeserialize(builder = AgencyStopIdRetrieveResponse.Builder::class)
@NoAutoDetect
class AgencyStopIdRetrieveResponse
private constructor(
    ...
    fun validate(): AgencyStopIdRetrieveResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgencyStopIdRetrieveResponse &&
    ...
    override fun toString() =
        "AgencyStopIdRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(agencyStopIdRetrieveResponse: AgencyStopIdRetrieveResponse) = apply {
            this.code = agencyStopIdRetrieveResponse.code
            this.currentTime = agencyStopIdRetrieveResponse.currentTime
            this.text = agencyStopIdRetrieveResponse.text
            this.version = agencyStopIdRetrieveResponse.version
            this.data = agencyStopIdRetrieveResponse.data
            additionalProperties(agencyStopIdRetrieveResponse.additionalProperties)
        }
        ...
        fun build(): AgencyStopIdRetrieveResponse =
