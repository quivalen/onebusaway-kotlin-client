...
@JsonDeserialize(builder = VehicleTripRetrieveResponse.Builder::class)
@NoAutoDetect
class VehicleTripRetrieveResponse
private constructor(
    ...
    fun validate(): VehicleTripRetrieveResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VehicleTripRetrieveResponse &&
    ...
    override fun toString() =
        "VehicleTripRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(vehicleTripRetrieveResponse: VehicleTripRetrieveResponse) = apply {
            this.code = vehicleTripRetrieveResponse.code
            this.currentTime = vehicleTripRetrieveResponse.currentTime
            this.text = vehicleTripRetrieveResponse.text
            this.version = vehicleTripRetrieveResponse.version
            this.data = vehicleTripRetrieveResponse.data
            additionalProperties(vehicleTripRetrieveResponse.additionalProperties)
        }
        ...
        fun build(): VehicleTripRetrieveResponse =
