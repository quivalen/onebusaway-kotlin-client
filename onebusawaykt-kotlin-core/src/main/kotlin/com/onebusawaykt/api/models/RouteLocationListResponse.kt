...
@JsonDeserialize(builder = RouteLocationListResponse.Builder::class)
@NoAutoDetect
class RouteLocationListResponse
private constructor(
    ...
    fun validate(): RouteLocationListResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RouteLocationListResponse &&
    ...
    override fun toString() =
        "RouteLocationListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(routeLocationListResponse: RouteLocationListResponse) = apply {
            this.code = routeLocationListResponse.code
            this.currentTime = routeLocationListResponse.currentTime
            this.text = routeLocationListResponse.text
            this.version = routeLocationListResponse.version
            this.data = routeLocationListResponse.data
            additionalProperties(routeLocationListResponse.additionalProperties)
        }
        ...
        fun build(): RouteLocationListResponse =
