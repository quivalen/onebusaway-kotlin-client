...
@JsonDeserialize(builder = RouteScheduleRetrieveResponse.Builder::class)
@NoAutoDetect
class RouteScheduleRetrieveResponse
private constructor(
    ...
    fun validate(): RouteScheduleRetrieveResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RouteScheduleRetrieveResponse &&
    ...
    override fun toString() =
        "RouteScheduleRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(routeScheduleRetrieveResponse: RouteScheduleRetrieveResponse) = apply {
            this.code = routeScheduleRetrieveResponse.code
            this.currentTime = routeScheduleRetrieveResponse.currentTime
            this.text = routeScheduleRetrieveResponse.text
            this.version = routeScheduleRetrieveResponse.version
            this.data = routeScheduleRetrieveResponse.data
            additionalProperties(routeScheduleRetrieveResponse.additionalProperties)
        }
        ...
        fun build(): RouteScheduleRetrieveResponse =
