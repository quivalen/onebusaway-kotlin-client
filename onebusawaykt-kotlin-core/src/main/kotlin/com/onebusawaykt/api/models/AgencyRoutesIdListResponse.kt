...
@JsonDeserialize(builder = AgencyRoutesIdListResponse.Builder::class)
@NoAutoDetect
class AgencyRoutesIdListResponse
private constructor(
    ...
    fun validate(): AgencyRoutesIdListResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgencyRoutesIdListResponse &&
    ...
    override fun toString() =
        "AgencyRoutesIdListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(agencyRoutesIdListResponse: AgencyRoutesIdListResponse) = apply {
            this.code = agencyRoutesIdListResponse.code
            this.currentTime = agencyRoutesIdListResponse.currentTime
            this.text = agencyRoutesIdListResponse.text
            this.version = agencyRoutesIdListResponse.version
            this.data = agencyRoutesIdListResponse.data
            additionalProperties(agencyRoutesIdListResponse.additionalProperties)
        }
        ...
        fun build(): AgencyRoutesIdListResponse =
