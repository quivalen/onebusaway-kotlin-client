...
@JsonDeserialize(builder = RouteTripListResponse.Builder::class)
@NoAutoDetect
class RouteTripListResponse
private constructor(
    ...
    fun validate(): RouteTripListResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RouteTripListResponse &&
    ...
    override fun toString() =
        "RouteTripListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(routeTripListResponse: RouteTripListResponse) = apply {
            this.code = routeTripListResponse.code
            this.currentTime = routeTripListResponse.currentTime
            this.text = routeTripListResponse.text
            this.version = routeTripListResponse.version
            this.data = routeTripListResponse.data
            additionalProperties(routeTripListResponse.additionalProperties)
        }
        ...
        fun build(): RouteTripListResponse =
