...
@JsonDeserialize(builder = RouteSearchRetrieveResponse.Builder::class)
@NoAutoDetect
class RouteSearchRetrieveResponse
private constructor(
    ...
    fun validate(): RouteSearchRetrieveResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RouteSearchRetrieveResponse &&
    ...
    override fun toString() =
        "RouteSearchRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(routeSearchRetrieveResponse: RouteSearchRetrieveResponse) = apply {
            this.code = routeSearchRetrieveResponse.code
            this.currentTime = routeSearchRetrieveResponse.currentTime
            this.text = routeSearchRetrieveResponse.text
            this.version = routeSearchRetrieveResponse.version
            this.data = routeSearchRetrieveResponse.data
            additionalProperties(routeSearchRetrieveResponse.additionalProperties)
        }
        ...
        fun build(): RouteSearchRetrieveResponse =
