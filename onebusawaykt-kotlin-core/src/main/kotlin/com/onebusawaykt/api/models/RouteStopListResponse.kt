...
@JsonDeserialize(builder = RouteStopListResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    fun validate(): RouteStopListResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RouteStopListResponse &&
    ...
    override fun toString() =
        "RouteStopListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(routeStopListResponse: RouteStopListResponse) = apply {
            this.code = routeStopListResponse.code
            this.currentTime = routeStopListResponse.currentTime
            this.text = routeStopListResponse.text
            this.version = routeStopListResponse.version
            this.data = routeStopListResponse.data
            additionalProperties(routeStopListResponse.additionalProperties)
        }
        ...
        fun build(): RouteStopListResponse =
