...
@JsonDeserialize(builder = AgencyVehicleListResponse.Builder::class)
@NoAutoDetect
class AgencyVehicleListResponse
private constructor(
    ...
    fun validate(): AgencyVehicleListResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgencyVehicleListResponse &&
    ...
    override fun toString() =
        "AgencyVehicleListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(agencyVehicleListResponse: AgencyVehicleListResponse) = apply {
            this.code = agencyVehicleListResponse.code
            this.currentTime = agencyVehicleListResponse.currentTime
            this.text = agencyVehicleListResponse.text
            this.version = agencyVehicleListResponse.version
            this.data = agencyVehicleListResponse.data
            additionalProperties(agencyVehicleListResponse.additionalProperties)
        }
        ...
        fun build(): AgencyVehicleListResponse =
