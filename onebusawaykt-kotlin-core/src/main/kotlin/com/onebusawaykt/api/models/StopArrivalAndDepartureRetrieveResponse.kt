...
@JsonDeserialize(builder = StopArrivalAndDepartureRetrieveResponse.Builder::class)
@NoAutoDetect
class StopArrivalAndDepartureRetrieveResponse
private constructor(
    ...
    fun validate(): StopArrivalAndDepartureRetrieveResponse = apply {
        if (!validated) {
            code()
            currentTime()
            text()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StopArrivalAndDepartureRetrieveResponse &&
    ...
    override fun toString() =
        "StopArrivalAndDepartureRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(
            stopArrivalAndDepartureRetrieveResponse: StopArrivalAndDepartureRetrieveResponse
        ) = apply {
            this.code = stopArrivalAndDepartureRetrieveResponse.code
            this.currentTime = stopArrivalAndDepartureRetrieveResponse.currentTime
            this.text = stopArrivalAndDepartureRetrieveResponse.text
            this.version = stopArrivalAndDepartureRetrieveResponse.version
            this.data = stopArrivalAndDepartureRetrieveResponse.data
            additionalProperties(stopArrivalAndDepartureRetrieveResponse.additionalProperties)
        }
        ...
        fun build(): StopArrivalAndDepartureRetrieveResponse =
