...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StopLocationListParams &&
            this.lat == other.lat &&
            this.lon == other.lon &&
    ...
    override fun toString() =
        "StopLocationListParams{lat=$lat, lon=$lon, latSpan=$latSpan, lonSpan=$lonSpan, query=$query, radius=$radius, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(stopLocationListParams: StopLocationListParams) = apply {
            this.lat = stopLocationListParams.lat
            this.lon = stopLocationListParams.lon
            this.latSpan = stopLocationListParams.latSpan
            this.lonSpan = stopLocationListParams.lonSpan
            this.query = stopLocationListParams.query
            this.radius = stopLocationListParams.radius
            additionalQueryParams(stopLocationListParams.additionalQueryParams)
            additionalHeaders(stopLocationListParams.additionalHeaders)
        }
        ...
        fun build(): StopLocationListParams =
            StopLocationListParams(
