...
class StopArrivalAndDepartureRetrieveParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StopArrivalAndDepartureRetrieveParams &&
    ...
    override fun toString() =
        "StopArrivalAndDepartureRetrieveParams{stopId=$stopId, serviceDate=$serviceDate, tripId=$tripId, stopSequence=$stopSequence, time=$time, vehicleId=$vehicleId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(
            stopArrivalAndDepartureRetrieveParams: StopArrivalAndDepartureRetrieveParams
        ) = apply {
            this.stopId = stopArrivalAndDepartureRetrieveParams.stopId
            this.serviceDate = stopArrivalAndDepartureRetrieveParams.serviceDate
            this.tripId = stopArrivalAndDepartureRetrieveParams.tripId
            this.stopSequence = stopArrivalAndDepartureRetrieveParams.stopSequence
            this.time = stopArrivalAndDepartureRetrieveParams.time
            this.vehicleId = stopArrivalAndDepartureRetrieveParams.vehicleId
            additionalQueryParams(stopArrivalAndDepartureRetrieveParams.additionalQueryParams)
            additionalHeaders(stopArrivalAndDepartureRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): StopArrivalAndDepartureRetrieveParams =
            StopArrivalAndDepartureRetrieveParams(
