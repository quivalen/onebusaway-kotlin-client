...
class TripReportProblemRetrieveParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TripReportProblemRetrieveParams &&
    ...
    class Builder {
        ...
        internal fun from(tripReportProblemRetrieveParams: TripReportProblemRetrieveParams) =
            apply {
                this.tripId = tripReportProblemRetrieveParams.tripId
                this.code = tripReportProblemRetrieveParams.code
                this.serviceDate = tripReportProblemRetrieveParams.serviceDate
                this.stopId = tripReportProblemRetrieveParams.stopId
                this.userComment = tripReportProblemRetrieveParams.userComment
                this.userLat = tripReportProblemRetrieveParams.userLat
                this.userLocationAccuracy = tripReportProblemRetrieveParams.userLocationAccuracy
                this.userLon = tripReportProblemRetrieveParams.userLon
                this.userOnVehicle = tripReportProblemRetrieveParams.userOnVehicle
                this.userVehicleNumber = tripReportProblemRetrieveParams.userVehicleNumber
                this.vehicleId = tripReportProblemRetrieveParams.vehicleId
                additionalQueryParams(tripReportProblemRetrieveParams.additionalQueryParams)
                additionalHeaders(tripReportProblemRetrieveParams.additionalHeaders)
            }
        ...
        fun build(): TripReportProblemRetrieveParams =
            TripReportProblemRetrieveParams(
    ...
    private constructor(
        ...
        fun known(): Known =
            when (this) {
                ...
                OTHER -> Known.OTHER
                else -> throw OnebusawayktInvalidDataException("Unknown Code: $value")
            }
